  ...
  return (
      ...
      <div className="card border-0">
        ...
        <div className="card-body">
          ...
          <Link to={`details/${props.category}/${props.uid}`} className="btn border-primary mt-2 text-primary">Learn more!</Link>
          <button onClick={(handleClick)}  className={ Click === true ? "btn btn-warning border-0" : " btn btn-outline-warning border-0" }>
